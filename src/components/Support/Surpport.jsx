...
const Support = () => {
  return (
    <div className="supportbackground pb-10">
      <p className="lg:text-[48px] text-center text-xl lg:pb-4 pt-8 underline " style={{color: "rgb(98, 62, 8)"}}>
        Support Us
      </p>
      <div className="container  flex lg:flex-row flex-col lg:gap-14  p-8 lg:px-28">
        ...
        <div className="support mt-0 lg:mt-6">
          <p className="lg:text-2xl" style={{color: "rgb(98, 62, 8)"}}>A/c no: 34615713229</p>
          <p className="lg:text-2xl" style={{color: "rgb(98, 62, 8)"}}>IFSC: SBIN0007194</p>
          <p className="lg:text-2xl" style={{color: "rgb(98, 62, 8)"}}>Branch: Denguajhar</p>
          <p className="pt-6 text-[25px] font-medium italic text-amber-800">
