...
const Support = () => {
  return (
    <div className="supportbackground pb-10">
      <p className="lg:text-[48px] text-center md:text-6xl text-4xl pb-4 pt-10 underline " style={{color: "rgb(98, 62, 8)"}}>
        Support Us
      </p>
      <div className="flex lg:flex-row md:flex-row flex-col  md:gap-8 lg:gap-14 p-4  md:p-8 lg:px-28">
        <img
          ...
          className=" lg:w-2/4 md:w-2/4 w-full mb-8 support-img  rounded-lg"
          alt=""
