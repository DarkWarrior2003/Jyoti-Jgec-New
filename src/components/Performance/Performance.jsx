  ...
  return (
    <div className="background">
      <div className=" p-6  text-center ">
        <p className="lg:text-4xl text-3xl underline text-center  text-amber-700 font-medium pb-2">
          Performance & Awards
        </p>
        ...
        <a href="/gallery">
          <button className="bg-transparent mt-2 mb-4 hover:bg-amber-500 text-amber-700 font-semibold hover:text-white py-2 px-4 border border-amber-500 hover:border-transparent rounded">
            Show More
          </button>
        </a>
      </div>
